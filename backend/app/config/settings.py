...
class Settings(BaseSettings):
    ...
    DEFAULT_REASONING_MODEL: str = Field(default="gemini-2.5-pro", alias="DEFAULT_REASONING_MODEL")
    DEFAULT_FAST_MODEL: str = Field(default="gemini-2.5-flash", alias="DEFAULT_FAST_MODEL")
    DEFAULT_EMBEDDING_MODEL: str = Field(default="text-embedding-004", alias="DEFAULT_EMBEDDING_MODEL")
    ...
    REDDIT_USER_AGENT: str = Field(default="ResearchOS/1.0", alias="REDDIT_USER_AGENT")
    ...
    CRAWL_USER_AGENT: str = Field(default="ResearchOS-Bot/1.0", alias="CRAWL_USER_AGENT")
